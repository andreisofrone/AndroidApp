...
namespace SecondaryAxis
{
	public class SecondaryAxisViewController : UIViewController, INChartSeriesDataSource, INChartValueAxisDataSource
	{
		...
		public NChartPoint [] Points (NChartSeries series)
		{
			...
			for (int i = 0; i < 10; ++i)
				result.Add (new NChartPoint (NChartPointState.PointStateAlignedToXWithXY (
		...
		public NSNumber Min (NChartValueAxis axis)
		{
		...
		public NSNumber Max (NChartValueAxis axis)
		{
